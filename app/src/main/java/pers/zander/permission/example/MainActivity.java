 ...
 */
package pers.zander.permission.example;
...
import pers.zander.okpermission.OkPermission;
...
//            }
        ...
        OkPermission.with(this)
            ...
            .onDenied(new Action<List<String>>() {
                ...
                public void onAction(@NonNull List<String> permissions) {
                    ...
                    if (OkPermission.hasAlwaysDeniedPermission(MainActivity.this, permissions)) {
    ...
    private void setPermission() {
        OkPermission.with(this).runtime().setting().start(REQUEST_CODE_SETTING);
    }
...
//                    File apk = new File(FileUtils.getExternalDir(App.get(), Environment.DIRECTORY_DOWNLOADS), "OkPermission.apk");
...
//        OkPermission.with(this).overlay().rationale(new OverlayRationale()).onGranted(new Action<Void>() {
//            @Override
//            public void onAction(Void data) {
//                showAlertWindow();
//            }
...
//        OkPermission.with(this).setting().write().rationale(new WriteSettingRationale()).onGranted(new Action<Void>() {
//            @Override
//            public void onAction(Void data) {
//                toast(R.string.successfully);
//            }
